...
[![Maven Central](https://img.shields.io/maven-central/v/io.inverno/inverno-oss-parent)](https://central.sonatype.com/search?namespace=io.inverno<xsl:text disable-output-escaping="yes"><![CDATA[&]]></xsl:text>name=inverno-oss-parent)
